...
docker run --entrypoint /bin/bash -it --rm -e REG_TOKEN='AAAK...4W' -e GH_OWNER='gt-omscs-se-2023summer' -e GH_REPOSITORY='6300Summer23Team127' --rm --name github-runner-gatech armyguy255a/github-runner-gatech:latest