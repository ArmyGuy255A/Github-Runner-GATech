...
docker run --rm -e REG_TOKEN='AAAPN2WZBR3QZJIPCRKU7J3ETFY2K' -e GH_OWNER='pdieppa3' -e GH_REPOSITORY='gatech-android-app-sample' --name github-runner-gatech armyguy255a/github-runner-gatech:latest